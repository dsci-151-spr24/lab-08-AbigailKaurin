...
evals %>% 
  summarise(means = mean(score), medians = mean(score), mins = min(score), maxs = max(score), sds = sd(score),
...
***The data is skewed to the left, and the majority of students rated their professors between `4` and `5`. This is about what I expected.***
...
evals%>%
  ...
  ylab("average professor evaluaiton") +
...
***The average rating for a teaching track professor is 4.28. The average rating for a tenure track professor is 0.12 points lower than a teaching track professor. The average rating for a tenured professor is 0.14 points lower than a teaching professors***
...
$$\widehat{score} = 4.4 + 0.14\times teaching + 0.2\times Tenure track$$ 


***The average rating for a tenured professor is 4.14. The average rating for a teaching professor is 0.14 points higher than a tenured professor. The average rating of a tenure track professor is 0.02 points higher than a tenured professor.***
